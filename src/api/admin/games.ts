...
import { gameValidator, gameUpdateValidator } from "../../zod/games";

// Create a games router with base path
...
gamesRouter.get("/", async (c) => {
  try {
    ...
    console.log("Admin ID:", admin.id); // Log the admin ID for debugging
